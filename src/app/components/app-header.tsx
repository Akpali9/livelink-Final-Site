...
export function AppHeader({ 
  ...
  return (
    <header className=" px-5 pt-10 pb-4 border-b border-[#1D1D1D]/10 sticky top-0 bg-white z-50 left-0 right-0">
      <div className="max-w-[480px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          {showBack && (
            <button 
              ...
              className="p-1 -ml-1 active:bg-[#1D1D1D]/10 transition-colors rounded-lg" 
              aria-label="Go back"
            >
          ...
          {showLogo && (
            ...
            >
              <h1 className="text-xl font-black uppercase tracking-tighter italic leading-none flex items-center gap-2">
                <div className="w-5 h-5 bg-[#1D1D1D] flex items-center justify-center text-white text-[8px] italic rounded-lg">
                  LL
                </div>
                LiveLink
              </h1>
        ...
        <div className="flex items-center gap-2 relative">
            ...
            <>
              ...
              <div className="relative">
                <button
                  ...
                  className="relative p-2 hover:bg-[#F8F8F8] transition-colors rounded-lg"
                  aria-label="Messages"
                >
                  ...
                  {showMessages && (
                    <>
                      ...
                      <motion.div
                        ...
                        className="absolute right-0 mt-2 w-80 bg-white border-2 border-[#1D1D1D] shadow-xl z-50 rounded-xl overflow-hidden"
                      >
                        <div className="p-4 border-b-2 border-[#1D1D1D] bg-[#F8F8F8] flex justify-between items-center">
                          <div className="flex items-center gap-2">
                            <Mail className="w-4 h-4 text-[#389C9A]" />
                            <h3 className="text-[10px] font-black uppercase tracking-widest italic">Messages</h3>
                          </div>
                          {unreadMessages > 0 && (
                            <span className="bg-[#389C9A] text-white text-[8px] font-black px-2 py-1 rounded-full">
                          ...
                          {recentConversations.length === 0 ? (
                            ...
                            recentConversations.map(conv => (
                              <Link
                                ...
                                onClick={() => setShowMessages(false)}
                                className={`block p-4 border-b border-[#1D1D1D]/10 hover:bg-[#F8F8F8] transition-colors ${
                              ...
                              >
                                <div className="flex items-start gap-3">
                                  ...
                                  {!conv.is_read && (
                                    <div className="w-2 h-2 bg-[#389C9A] shrink-0 mt-2 rounded-full" />
                                  )}
                                </div>
                              </Link>
                            ))
                        ...
                        {recentConversations.length > 0 && (
                          <div className="p-3 border-t-2 border-[#1D1D1D] bg-[#F8F8F8]">
                            <Link
                              to={messagesPath}
                              onClick={() => setShowMessages(false)}
                          ...
                          {notifications.length === 0 ? (
                            ...
                            notifications.map(n => (
                              <div
                                ...
                                className={`p-4 border-b border-[#1D1D1D]/10 hover:bg-[#F8F8F8] cursor-pointer transition-colors ${
                              ...
                              >
                                <div className="flex items-start gap-3">
                                  ...
                                  {!n.is_read && (
                                    <div className="w-2 h-2 bg-[#FEDB71] shrink-0 mt-2 rounded-full" />
                                  )}
                                </div>
                              </div>
                            ))
          ...
          <div className="relative ml-1">
            <button
              ...
              className="w-9 h-9 border-2 border-[#1D1D1D] flex items-center justify-center bg-white active:scale-95 transition-transform rounded-full overflow-hidden hover:bg-[#F8F8F8]"
              ...
              {showProfileMenu && isAuthenticated && (
                <>
                  ...
                  <motion.div
                    ...
                    className="absolute right-0 mt-2 w-64 bg-white border-2 border-[#1D1D1D] shadow-xl z-50 rounded-xl overflow-hidden"
                  >
                    {/* User chip */}
                    ...
                    <div className="p-2">
                      <Link
                        to={profilePath}
                        onClick={() => setShowProfileMenu(false)}
                        className="w-full text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-[#1D1D1D] hover:text-white flex items-center gap-3 transition-colors rounded-lg"
                      >
                      ...
                      <button
                        ...
                        className="w-full text-left px-4 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-[#1D1D1D] hover:text-white text-red-500 flex items-center gap-3 transition-colors rounded-lg"
                      >
