          ...
          <div className="space-y-1">
            {navItems.map((item, i) => (
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-[10px] font-black uppercase tracking-widest hover:bg-[#F8F8F8] text-[#1D1D1D]/60 hover:text-[#1D1D1D] transition-all"
              >
