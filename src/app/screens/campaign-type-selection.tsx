...
export function CampaignTypeSelection() {
  ...
  const handleContinue = () => {
    ...
    let campaignType = "";
    let bidAmount = 25;      // default bid per 4 streams (can be dynamic later)
    let creatorCount = 1;    // default number of creators
    let campaignName = "";   // can be prefilled later
    ...
    navigate("/business/campaign/creation", {
      state: {
        campaignType,
        bidAmount,
        creatorCount,
